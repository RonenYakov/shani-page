 ...
 *   public/videos/restaurants/   → Restaurants category
...
const restaurants = import.meta.glob('/public/videos/restaurants/*.mp4', { eager: true })
...
export const VIDEO_MANIFEST: Record<string, string[]> = {
  ...
  restaurants: toUrls(restaurants),
